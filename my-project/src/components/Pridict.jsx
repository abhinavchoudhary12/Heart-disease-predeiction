...
<select name="cp" className="block appearance-none w-full  border border-gray-200 text-rose-300 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-rose-400 text-center" id="cp"  onChange={this.handleOnChange}>
...
<div className="relative">
<select  name="restecg" className="block appearance-none w-full  border border-gray-200 text-rose-300 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-rose-400 text-center" id="restecg"  onChange={this.handleOnChange}>
...
<div className="relative">
<select name="exang" className="block appearance-none w-full  border border-gray-200 text-rose-300 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-rose-400 text-center" id="grid-cpt"  onChange={this.handleOnChange}>
  <option value="0">0</option>
    <option value="1">1</option>
